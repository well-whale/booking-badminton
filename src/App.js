...
function App() {
  return (
    <React.StrictMode>
      <BrowserRouter>
        <Routes>
          <Route path="login" element={<><Header /><LoginAndSignupForm /><Footer /></>} />
          <Route path="/" element={<><Header /><HomePage /><Footer /></>} />
          <Route path="googleoauth" element={
            <GoogleOAuthProvider clientId="21328047732-02qfv7vb9ku5n0ov51v8d3k8vqb7e1ab.apps.googleusercontent.com">
              <GoogleOAuth />
            </GoogleOAuthProvider>
          } />
          <Route path="loginotp" element={<LoginOTP />} />
          <Route path="/view/:idCourt" element={<><Header /><CourtDetail /><ListCourt /><Footer /></>} />
          <Route path="/search" element={<><Header /><SearchAndList /></>} />
          <Route path="/booking/:idCourt" element={<><Header /><TimeSlots /><Footer /></>} />
          <Route path="payment" element={<><Header /><Payment /><Footer /></>} />
          <Route path="admin/home" element={<AdminHome />} />
          <Route path="admin/users" element={<Customer />} />
          <Route path="admin/court" element={<Courts />} />
          <Route path="admin/users/new" element={<NewUser />} />
          <Route path="/admin/court/update/:courtId" element={<UpdateCourt />} />
        </Routes>
      </BrowserRouter>
    </React.StrictMode>
  );
